...
@NgModule({
  ...
  declarations: [ DropsComponent, DropNoteComponent, DropMoneyComponent, DropTaskComponent, DropRateComponent, DropGoalComponent, DropSystemComponent, DropPhotoComponent ],
