...
@Component({
  ...
  templateUrl: './drop-money-detail.component.html',
  styleUrls: ['./drop-money-detail.component.scss']
})
export class DropMoneyDetailComponent {
    ...
    constructor(
        ...
        combineLatest([this.oos.streams(), this.oos.drops(), this.route.paramMap]).pipe(take(1)).subscribe( v => {
            ...
            this.drop = id === 'new' ? new Drop({
                ...
                name: "", 
                type: "MONEY_TYPE",
                content: { description: "", value: 0, type: "expense", currency: "" },
                recurrence: "none",
                streams: [this.oos.getStreamByType("MONEY_TYPE")],
